...
public class optst {static {
    System.setProperty("webdriver.chrome.driver",
            "C:\\\\Users\\\\veereshkumar.ghooli\\\\Downloads\\\\chromedriver_win32\\\\chromedriver.exe");
}
WebDriver driver;
...
public void launchBrowser() throws InterruptedException {
    ...
    driver.get("https://mobileworld.banyanpro.com/order.html");
}
...
public void enterFirstName() throws InterruptedException {
    driver.findElement(By.id("inputFirstName")).sendKeys("Veereshkuamr");
}
...
public void enterLastName() throws InterruptedException {
    driver.findElement(By.xpath("(//input[@id='inputFirstName'])[2]")).sendKeys("VRG");
}
...
public void enterEmailId() throws InterruptedException {
    driver.findElement(By.id("inputEmail")).sendKeys("mrvg@gmail.com");
}
...
public void enterNumber() throws InterruptedException {
    driver.findElement(By.xpath("(//input[@type='number'])[1]")).sendKeys("9035071067");
}
...
public void enterAddress1() throws InterruptedException {
    driver.findElement(By.id(" address1")).sendKeys("Sbh bank");
}
...
public void enterAddress2() throws InterruptedException {
    driver.findElement(By.id("address2")).sendKeys("Ramnagar");
}
...
public void enterCity() throws InterruptedException {
    driver.findElement(By.id("inputCity")).sendKeys("gulbarga");
}
...
public void enterZIP() throws InterruptedException {
    driver.findElement(By.id("inputZip")).sendKeys("585102");
}
...
public void selectBrand() throws InterruptedException {
    ...
    driver.findElement(By.xpath("//*[.='Apple']")).click();
    Assert.assertTrue(driver.findElement(By.xpath("//*[.='Apple']")).isSelected());
}
